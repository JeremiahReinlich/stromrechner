...
class StromrechnerApp {
    ...
    pruefeTarifUeberschneidungEchtzeit() {
        ...
        const hatUeberschneidung = this.pruefeTarifUeberschneidung(von, bis, this.bearbeitungsTarifId);
    ...
    validiereBackup(backup) {
        ...
        for (const messwert of backup.messwerte) {
            if (!messwert.id || !messwert.datum) {
                throw new Error('Messwert fehlt ID oder Datum');
            }
        ...
        for (const tarif of backup.tarife) {
            if (!tarif.id || !tarif.von) {
                throw new Error('Tarif fehlt ID oder Von-Datum');
            }
