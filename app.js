...
class StromrechnerApp {
    ...
    bindEvents() {
        ...
        // Monatsnavigation
        document.getElementById('monat-vorher').addEventListener('click', () => this.wechsleMonat('vorher'));
        document.getElementById('monat-naechster').addEventListener('click', () => this.wechsleMonat('naechster'));
        ...
        this.handleSwipe = () => {
            ...
            const verticalThreshold = 30; // Max vertikale Bewegung für Swipe

            const diffX = touchStartX - touchEndX;
            const diffY = Math.abs(touchStartY - touchEndY);

            // Nur Swipe erkennen, wenn Bewegung überwiegend horizontal (kein Scrollen)
