...
class StromrechnerApp {
    ...
    bindEvents() {
        ...
        // Undo-Button (Desktop: Klick, Mobile: Long-Press)
        ...
        undoBtn.addEventListener('touchstart', (e) => {
            ...
            }, 2000); // 2 Sekunden Long-Press (erhöht)
        });
        ...
        undoBtn.addEventListener('touchmove', () => {
            clearTimeout(longPressTimer);
            undoCircle.classList.remove('active');
        });
...
erstelleTarifElement(tarif) {
    ...
    toggleExpertenmodus() {
        console.log('toggleExpertenmodus aufgerufen. Expertenmodus vorher:', this.expertenmodus);

        this.expertenmodus = !this.expertenmodus;
        console.log('Expertenmodus nachher:', this.expertenmodus);
